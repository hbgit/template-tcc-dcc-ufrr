...
% Alterar após a aprovação da defesa de TCC 2
\include{secoes/ficha_catalografica}
\include{secoes/ata-aprovacao}
...
\input{secoes/sec-trabalhos-re}
\input{secoes/sec-solucao-pro}
\input{secoes/sec-ava-experimentos}
\input{secoes/sec-conclusao}
